...
export default function PostPage() {
    ...
    const {
        sendComment, updateComment, toggleBookMark,
        getPost, post, isDeletingComment, deleteComment, toggleLike, isSendingComment, isBookMarke
    } = usePostStore();
    ...
    return (
        <div className="flex-1">
            {post ? (
                <div
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <Link to={post.userId._id === authUser?._id ? '/profile' : `/user/${post.userId._id}`} className="size-10 self-start">
                                <img
                ...
                <span className="flex items-center justify-center text-gray-500">No post yet</span>
            )}
        </div>
